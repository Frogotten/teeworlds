...
void CMenus::RenderServerbrowserFilters(CUIRect View)
{
	...
	RenderTools()->DrawUIRect(&FilterHeader, vec4(1,1,1,0.25f), 0, 4.0f);
...
void CMenus::RenderServerbrowserServerDetail(CUIRect View)
{
	...
	RenderTools()->DrawUIRect(&ServerHeader, vec4(1,1,1,0.25f), 0, 4.0f);
...
void CMenus::RenderServerbrowser(CUIRect MainView)
{
	...
	*/
	...
	CUIRect ServerList, ToolBox, StatusBox, TabBar, TabBar2;
	...
	ToolBox.HSplitTop(25.0f, &TabBar2, &ToolBox);
...

	{
		...
		TabBar2.VSplitLeft(75.0f, &TabButton0, &TabBar2);
		TabBar2.VSplitLeft(55.0f, &TabButton1, &TabButton2);
	...
	/*{
		...
		static int s_FriendsTab = 0;
		if (DoButton_MenuTab(&s_FriendsTab, Localize("Friends"), ToolboxPage==2, &TabButton2, CUI::CORNER_BL))
			ToolboxPage = 2;
	...
	// tool box
	{
		RenderTools()->DrawUIRect(&ToolBox, vec4(0.0f, 0.0f, 0.0f, 0.15f), 0, 4.0f);
